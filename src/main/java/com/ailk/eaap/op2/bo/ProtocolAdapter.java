...
public class ProtocolAdapter implements Serializable{
private static final long serialVersionUID = 1L;
	...
	private String exampleSrcDocument;
	private String exampleTarDocument;
	/**
	 * 租户ID
	 */
	...
	public String getExampleSrcDocument() {
		return exampleSrcDocument;
	}
	public void setExampleSrcDocument(String exampleSrcDocument) {
		this.exampleSrcDocument = exampleSrcDocument;
	}
	public String getExampleTarDocument() {
		return exampleTarDocument;
	}
	public void setExampleTarDocument(String exampleTarDocument) {
		this.exampleTarDocument = exampleTarDocument;
	}	
}
